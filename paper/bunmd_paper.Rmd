...
### 3.1 The Old-Age Mortality of the Foreign-Born
...
### 3.2 Country-of-Birth Differences
...
### 3.3 Racial Differences Among Cuban Immigrants
...
and birth year in Table 2 below. We can see that Black Cuban
...
\end{tabular} 
\caption*{Table 2: Regression results for mean age at death of Cuban immigrants by
race, birth year, and sex}
\end{table} 


### 3.4 Translating Regression Results into Life Expectancy at Age 65  
...
### 3.6 Gompertz Maximum Likelihood Estimation: Race Differentials  
