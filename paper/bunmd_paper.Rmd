...
\begin{figure}[H]
  ...
  \caption{BUNMD Death Coverage for persons 65+. Coverage is most complete in the BUNMD for the window of 1988 to 2005. Complete cases — records with a information on sex, birthplace, and race — }
...
death in which population A has an $(e65)$ — life expectancy at age 65 — of 18 years and population B has an $e65$ of 19 years. 
...
\begin{figure}[H]
  ...
  \caption{Difference in mean age of death between natives and foreign-born. Grey line represents }
...
\begin{figure}[H]
  ...
  \caption{Difference in life expectancy at age 65 (e65) in Cuyahoga County for the birth cohort of 1900.}
...
We chose Alabama and Texas as they had a large enough subpopulations, after disaggregation by birth cohort, for the Gompertz MLE approach to produce reasonable estimates. Developing diagnostics to assess the fit of the Gompertz MLE approach and estimate uncertainty is an area for future research. 
...
Table 1: The selection rules used to construct the BUNMD. For a given variable, we selected values from the death record, if available. If a value wasn't available in the death record, we used chose a value from the application record using a selection rules. If it wasn't available in either the death or application entry, we selected it from the claim record. 
