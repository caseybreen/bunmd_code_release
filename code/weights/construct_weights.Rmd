...
This notebook to generates post-stratification person-weights for the BUNMD up to the HMD totals. 
...
## deaths from HMD 
## update this path
hmd_deaths <-  fread("/path/to/Deaths_lexis/USA.Deaths_lexis.txt") %>%
