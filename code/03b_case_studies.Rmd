...
```{r}
## combine plots 
gompertz_immigrant_plot <- cowplot::plot_grid(gompertz_results_women_plot, gompertz_results_men_plot, nrow = 2) 
...
ggsave(plot = cleveland_plot_combined, filename = here("figs/cleveland_plot_combined.pdf"), labels = "auto", width = 14, height = 18)
```
