...
truncated_means_plot1 <- trunc_diff %>% 
  ...
  annotate("text", x = 102.8, y = 3500, label = paste0("e65 Difference = ", round(trunc_diff_means$e65_19_mean - trunc_diff_means$e65_18_mean, 1), " years"))
...
truncated_means_plot2 <- trunc_diff_truncated %>% 
  ...
  annotate("text", x = 102.8, y = 3500, 
           label = paste0("e65 Difference = ", round(trunc_diff_means_truncated$e65_19_mean - trunc_diff_means_truncated$e65_18_mean, 1), " years"))
  
truncated_means <- cowplot::plot_grid(truncated_means_plot1, truncated_means_plot2, nrow = 2, labels = "auto")

ggsave(plot = truncated_means, filename = here("figs/truncated_means.pdf"), width = 7, height = 6.1)
```
...
{
  print(byear.vec[i])
  adjust.factor.vec[i] <- get.bunmd.adjust.factor(byear.vec[i], b = 0.1, M = 84, N = 10^7)
}
